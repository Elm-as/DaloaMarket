...
const CREDIT_PACKS = [
  { 
    ...
    credits: 3, 
    price: 500,
    description: 'Pour publier vos premières annonces',
    popular: false
  },
  { 
    id: 'regular', 
    ...
    credits: 10, 
    price: 1500,
    description: 'Le plus populaire pour publier plusieurs annonces',
    popular: true
  },
  { 
    id: 'pro', 
    ...
    credits: 30, 
    price: 3500,
    description: 'Pour publier beaucoup d’annonces',
    popular: false
  },
];
...
const AchatCreditsPage: React.FC = () => {
  ...
  // Correction du bloc JSX mal fermé dans le rendu du step 'success'
      ...
      <div className="min-h-screen bg-gradient-to-br from-grey-50 to-grey-100 flex items-center justify-center p-4">
        <div className="bg-white rounded-2xl lg:rounded-3xl shadow-xl p-6 lg:p-8 max-w-md w-full text-center">
          ...
          <div className="space-y-3">
            ...
            <button
              onClick={() => navigate('/')}
              className="w-full border-2 border-grey-300 text-grey-700 font-semibold py-3 lg:py-4 px-6 rounded-xl lg:rounded-2xl hover:border-grey-400 hover:bg-grey-50 transition-all duration-200 text-base lg:text-lg"
            >
              Retour à l'accueil
            </button>
          </div>
